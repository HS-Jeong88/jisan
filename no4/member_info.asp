					...
					<Form name="frm" id="frm" method='post'>
						...
						<tbody>
							...
							<tr>
								...
								<td colspan="2">
									<input type="text" class="basic_input w143" name="email_1" id="email_1" value="<%=email_1%>"
										data-valid="notnull" data-alert="이메일주소">
									@
									<input type="text" class="basic_input w143" name="email_2" id="email_2" value="<%=email_2%>"
										data-valid="notnull" data-alert="이메일주소">
							...
							<tr>
								...
								<td colspan="2">
									...
									-
									<input type="text" class="basic_input w100" name="phone2" id="phone2" maxlength="4"
										numberonly="true" data-valid="notnull" data-alert="휴대전화번호" Value="<%=array_hp(1)%>">
									-
									<input type="text" class="basic_input w100" name="phone3" id="phone3" maxlength="4"
										numberonly="true" data-valid="notnull" data-alert="휴대전화번호" Value="<%=array_hp(2)%>">
								</td>
							</tr>
							<tr>
								...
								<td>
									...
									<input type="checkbox" name="mb_sms_golf" value="y" class="smschk" <% If mb_sms_golf="y" Then%>
									checked <%End If%>>
									<label for="">골프장</label>
									&nbsp;&nbsp;
									<input type="checkbox" name="mb_sms_resort" value="y" class="smschk" <% If mb_sms_resort="y"
									Then%>
									checked <%End If%>>
							...
							<tr>
								...
								<td>
									...
									<label for="">전체수신</label>
									<span class="bracket">(</span>
									<input type="checkbox" name="mb_email_golf" value="y" class="emailchk" <% If mb_email_golf="y"
									Then%>
									checked <%End If%>>
									<label for="">골프장</label>
									&nbsp;&nbsp;
									<input type="checkbox" name="mb_email_resort" value="y" class="emailchk" <% If mb_email_resort="y"
									Then%> checked <%End If%>>
									<label for="" class="last">스키장</label>
									<span class="bracket">)</span>
									&nbsp;&nbsp;&nbsp;&nbsp;
